...
`;default:throw Error(`Unknown purpose '${e.section}' for template rendering.`)}};function getUpdatedCrowsnestConfigurationForVaoc(){let e=o.serverSchema.parse(process.env),r=l().join(e.KLIPPER_CONFIG_PATH,"crowsnest.conf");return(0,a.zM)(r,[{section:"crowsnest",body:`log_path: /home/pi/printer_data/logs/crowsnest.log
log_level: verbose
delete_log: false
no_proxy: false
...
resolution: 1920x1080
max_fps: 30
`.trim()}])}function getCommonBoilerplateConfigurationFileContent(e,r,t){let a=o.serverSchema.parse(process.env),s=l().join(a.KLIPPER_CONFIG_PATH,r),d=(0,i.existsSync)(s);return((0,n.getLogger)().debug(`getting content for ${r}, exists=${d}, forceDefault=${e}`),e||!d)?`# WARNING. THIS FILE IS GENERATED BY RATOS AND
